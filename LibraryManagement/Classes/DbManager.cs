...
namespace LibraryManagement.Classes
{
    public class DbManager
    {
        ...
        public List<Item> GetItems(string conString)
        {
        ...
        //Get count of item in collection
        public int GetCollectionCount(string conString)
        {
            SqlConnection con = new SqlConnection(conString);
        ...
        //Add Member into Admin table i.e Members table
        public int AddMember(Member memberDetail)
        {
            int id = 0;
            SqlCommand cmd =
                       new SqlCommand(
                           "Insert into Members(Username,Pwd,EmailId) values(@Username,@Pwd,@EmailId)",
                           con);
